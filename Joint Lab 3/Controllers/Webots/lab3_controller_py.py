...
if case == 2:
    ...
    while supervisor.getTime() - t < 11:
        ...
        left_motor.setVelocity(-1.0)
        right_motor.setVelocity(1.0 - 2.0*(supervisor.getTime() - t2))
...
if case == 3:
    while supervisor.getTime() - t < 1:
        ...
        left_motor.setVelocity(1.5*(supervisor.getTime() - t))
        right_motor.setVelocity(1.5*(supervisor.getTime() - t))
    ...
    while supervisor.getTime() - t < 11:
        ...
        left_motor.setVelocity(1.5 - 1.5*(supervisor.getTime() - t2))
        right_motor.setVelocity(1.5)
        
        print(supervisor.getTime() - t2)

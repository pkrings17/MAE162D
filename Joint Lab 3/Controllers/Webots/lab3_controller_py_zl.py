...
if case == 2:
    while supervisor.getTime() - t < 1:
        ...
        right_motor.setVelocity((supervisor.getTime() - t)*1.5)
    ...
    while supervisor.getTime() - t < 11:
        ...
        left_motor.setVelocity(-0.5 + 2.0*(supervisor.getTime() - t2))
        right_motor.setVelocity(1.5)
...
if case == 3:
    while supervisor.getTime() - t < 1:
        ...
        left_motor.setVelocity(2.0*(supervisor.getTime() - t))
        right_motor.setVelocity(2.0*(supervisor.getTime() - t))
    ...
    while supervisor.getTime() - t < 11:
        ...
        left_motor.setVelocity(2.0 - 3.0*(supervisor.getTime() - t2)))
        right_motor.setVelocity(2.0 - 2.0*(supervisor.getTime() - t2)))

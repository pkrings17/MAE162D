...
if case == 2:
    while supervisor.getTime() - t < 1:
        ...
        left_motor.setVelocity((supervisor.getTime() - t)*-2.0)
    ...
    while supervisor.getTime() - t < 11:
        ...
        left_motor.setVelocity(-2.0)
        right_motor.setVelocity(2.0 - 4.0*(supervisor.getTime() - t2))
...
if case == 3:
    while supervisor.getTime() - t < 1:
        ...
        right_motor.setVelocity(-0.5*(supervisor.getTime() - t))
    ...
    while supervisor.getTime() - t < 11:
        ...
        right_motor.setVelocity(-0.5 + 1.0*(supervisor.getTime() - t2))

...
y_max = 10
theta_max = 2*math.pi
d = 0.05 	# diameter of wheels in m
w = 0.09        # distance between wheels in m
...
def main():
    ...
    if case == 2:
        for i in range(500):
            currentState = x_next(currentState, [-1.5*(i/500.0),0.5*(i/500.0)])
            # print timestep number, x, y, theta
            s = str(currentState[0]) + "," + str(currentState[1]) + "," + str(currentState[2]) + "," + str(currentState[3])
            f.write(s)
            f.write('\n')
        for i in range(4500):
            currentState = x_next(currentState, [-1.5,0.5])
            # print timestep number, x, y, theta
            s = str(currentState[0]) + "," + str(currentState[1]) + "," + str(currentState[2]) + "," + str(currentState[3])
            f.write(s)
            f.write('\n')
        for i in range(500):
            currentState = x_next(currentState, [-1.5,0.5 - 2.0*(i/500.0)])
            # print timestep number, x, y, theta
            s = str(currentState[0]) + "," + str(currentState[1]) + "," + str(currentState[2]) + "," + str(currentState[3])
            f.write(s)
            f.write('\n')
    ...
    if case == 3:
        for i in range(500):
            currentState = x_next(currentState, [1.5*(i/500.0),1.0*(i/500.0)])
            # print timestep number, x, y, theta
            s = str(currentState[0]) + "," + str(currentState[1]) + "," + str(currentState[2]) + "," + str(currentState[3])
            f.write(s)
            f.write('\n')
        for i in range(4500):
            currentState = x_next(currentState, [1.5,1.0])
            # print timestep number, x, y, theta
            s = str(currentState[0]) + "," + str(currentState[1]) + "," + str(currentState[2]) + "," + str(currentState[3])
            f.write(s)
            f.write('\n')
        for i in range(500):
            currentState = x_next(currentState, [1.5 - 2.5*(i/500.0),1.0 - 2.5*(i/500.0)])
            # print timestep number, x, y, theta
            s = str(currentState[0]) + "," + str(currentState[1]) + "," + str(currentState[2]) + "," + str(currentState[3])
            f.write(s)
            f.write('\n')
        for i in range(4500):
            currentState = x_next(currentState, [-1.0,-1.5])
            # print timestep number, x, y, theta
            s = str(currentState[0]) + "," + str(currentState[1]) + "," + str(currentState[2]) + "," + str(currentState[3])
            f.write(s)
            f.write('\n')

...
def main():
    ...
    if case == 2:
        ...
        for i in range(4500):
            ...
            f.write('\n')
        for i in range(500):
            currentState = x_next(currentState, [-2.0,2.0 - 4.0*(i/500.0)])
            # print timestep number, x, y, theta
            s = str(currentState[0]) + "," + str(currentState[1]) + "," + str(currentState[2]) + "," + str(currentState[3])
            f.write(s)
            f.write('\n')
    ...
    if case == 3:
        for i in range(500):
            currentState = x_next(currentState, [-1.0*(i/500.0),-0.5*(i/500.0)])
            # print timestep number, x, y, theta
            s = str(currentState[0]) + "," + str(currentState[1]) + "," + str(currentState[2]) + "," + str(currentState[3])
            f.write(s)
            f.write('\n')
        for i in range(4500):
            currentState = x_next(currentState, [-1.0,-0.5])
            # print timestep number, x, y, theta
            s = str(currentState[0]) + "," + str(currentState[1]) + "," + str(currentState[2]) + "," + str(currentState[3])
            f.write(s)
            f.write('\n')
        for i in range(500):
            currentState = x_next(currentState, [-1.0 + 2.0*(i/500.0),-0.5 + 1.0*(i/500.0)])
            # print timestep number, x, y, theta
            s = str(currentState[0]) + "," + str(currentState[1]) + "," + str(currentState[2]) + "," + str(currentState[3])
            f.write(s)
            f.write('\n')
